...
<body>
    ...
    <div class="wrap">
        <?php
            NavBar::begin([
                'brandLabel' => '<i class="glyphicon glyphicon-tint"></i> ' . Yii::$app->params['site_name'],
                'brandUrl' => '/',
                'options' => [
            ...
            if (Yii::$app->user->isGuest) {
                ...
                array_unshift($menuItems,
                    ...
                    ['label' => '<i class="glyphicon glyphicon-file"></i> Статті', 'url' => ['/post/index']],
                    ['label' => '<i class="glyphicon glyphicon-bookmark"></i> Розділи', 'url' => ['/category/index']],
                    ['label' => '<i class="glyphicon glyphicon-tags"></i> Ключові слова', 'url' => ['/tag/index']],
                    ['label' => '<i class="glyphicon glyphicon-film"></i> Слайд', 'url' => ['/slider/index']],
